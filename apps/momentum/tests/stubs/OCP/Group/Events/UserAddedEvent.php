...
/**
 * Test-only stub reproducing the slice of \OCP\Group\Events\UserAddedEvent's
 * public signature this app's {@see \OCA\Momentum\Listener\GroupMembershipListener}
 * depends on (operations.md Access Reconciliation — scoped scope, G12: a
 * group-membership change triggers scoped reconciliation). Never shipped to
